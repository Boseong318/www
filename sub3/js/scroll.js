$(document).ready(function () {
    ...
    $('.dlab_box .dlab_detail1').addClass('boxMove');
    //첫번째 내용글 애니메이션 처리
    //var smh= $('.main').height();       //메인 비주얼의 높이
    var h1= $('.dlab_box .dlab_detail1').offset().top-1000 ;
    var h2= $('.dlab_box .dlab_detail2').offset().top-400 ;
    ...
    $(window).on('scroll',function(){
        ...
        if(scroll>=0 && scroll<h1){
            ...
            $('.dlab_box .dlab_detail2').addClass('boxMove');
        }
