$(document).ready(function () {
    ...
    var h1= $('#content .con_box:eq(0)').offset().top-400 ;
    var h2= $('#content .con_box:eq(1)').offset().top-650  ;
    var h3= $('#content .contribute_box').offset().top-650  ;
    ...
    */
        ...
        if(scroll>=0 && scroll<h1){
            $('#content .con_box:eq(0)').addClass('boxMove');
            //첫번째 내용 콘텐츠 애니메이

        }else if(scroll>=h1 && scroll<h2){
             $('#content .con_box:eq(1)').addClass('boxMove');

        }else if(scroll>=h2 && scroll<h3){
            $('#content .contribute_box').addClass('boxMove');
